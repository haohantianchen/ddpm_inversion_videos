...
if __name__ == "__main__":
    ...
    parser.add_argument("--cfg_src", type=float, default=7.5)
    ...
    save_path = "/raid/lurenjie/DDPM_inversion/results_5_23/densepose_prog_noise_with_controlnet_with_cf_self-attention"
    ...
    for i in range(len(full_data)):
        ...
        # 新增control_image输入
        control_image_path = current_image_data['control_img']
